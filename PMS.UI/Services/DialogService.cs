...
namespace PMS.Views.Services
{
    public sealed class DialogService : IDialogService
    {
        public bool TryAddProject(out string name, out DateTime deadline)
        {
            ...
            var dlg = new AddProjectDialog { Owner = Application.Current.MainWindow, DataContext = vm, Title="Add project" };
        ...
        public bool TryEditProject(ProjectItemViewModel pvm, out string newName, out DateTime newDeadline)
        {
            ...
            var dlg = new AddProjectDialog { Owner = Application.Current.MainWindow, DataContext = vm, Title = "Edit project" };
            if (dlg.ShowDialog() == true)
            {
        ...
        public bool TryAddTask(out TaskModel taskModel)
        {
            ...
            var dlg = new AddTaskDialog { Owner = Application.Current.MainWindow, DataContext = vm, Title = "Add task" };
            if (dlg.ShowDialog() == true)
            {
